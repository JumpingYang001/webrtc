...
class MockIceTransport : public IceTransportInternal {
 public:
  ...
  MOCK_METHOD(cricket::IceTransportState, GetState, (), (const override));
  ...
  MOCK_METHOD(void, SetIceRole, (cricket::IceRole), (override));
  ...
  MOCK_METHOD(void,
              ...
              (const cricket::IceParameters&),
              (override));
  MOCK_METHOD(cricket::IceParameters*,
  ...
  MOCK_METHOD(cricket::IceParameters*,
              ...
              (),
              (const, override));
  MOCK_METHOD(void, SetRemoteIceMode, (cricket::IceMode), (override));
  ...
  MOCK_METHOD(const cricket::Connection*,
              ...
              (),
              (const, override));
  MOCK_METHOD(std::optional<const cricket::CandidatePair>,
